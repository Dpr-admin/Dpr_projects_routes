  ...
  constructor(props) {
    ...
    this.state = {
      footerItems: [
        {
          title: "DPR Projects",
          icon: "mdi mdi-skyscraper",
          links: [
            { linkTitle: "Home", link: "#" },
            { linkTitle: "Project Details", link: "#" },
            { linkTitle: "Highlights", link: "#" },
            { linkTitle: "Amenities", link: "#" },
            { linkTitle: "Project Plan", link: "#" },
          ...
          <Container>
            <Row>
              ...
              <Col lg="3" className="mt-4">
                <h4>Visit Us <a href="https://dprprop.com" >dprprop.com</a></h4>
                <div className="text-muted mt-4">
                <p>Your perfect home awaits – Explore our listings and find your dream property today.</p>
                <p>Discover exceptional real estate opportunities and start your journey to a new home with us.</p>
                </div>
